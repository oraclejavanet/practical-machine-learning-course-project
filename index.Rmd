...
fitControlRpart <- rpart.control(method = "cv",
                                 number = 3,
                                 verboseIter = FALSE)

fitControlTrain <- trainControl(method = "cv",
                                number = 3,
                                verboseIter = FALSE,
                                allowParallel = TRUE)
```
...
which shows that the model produces very accurate predictions for the class of
dumbbell exercise.
